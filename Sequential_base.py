...
# lets create nodes (they are only python function)
...
# our state and nodes are ready , now it's time to create the graph
# for creating graph we need to connect these nodes and for connecting we use the edges
